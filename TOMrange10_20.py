...
output_name = '10_20outputSID%s.csv' % SID
...
def readInput():
	...
	cr = csv.reader(open("input10_20.csv", "rU"), dialect=csv.excel_tab)
	while True:
...
rangeMin = 10 # lower range for this run, not currently used in logic
rangeMax = 20 # upper range for this run, just used for text on screen
